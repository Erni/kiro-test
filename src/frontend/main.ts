 ...
 * `public/index.html` and calls that view's `init` with it. This module has
 * no logic of its own beyond this composition — no rendering, no
 * Backend_API calls, no state.
 */
